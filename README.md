...
Semanticc HTML elements are used to define different parts of the web page. 
...
Git lets you and lets certain users who are allowed to push code to your respostiory. Git also has a Forking feature that allows users to create a copy of a respository on their own computer for them to work on without changing the main respository. 
